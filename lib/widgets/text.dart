...
final TextStyle headingBlack27 = GoogleFonts.poppins(
    fontWeight: FontWeight.w600, fontSize: getProportionateScreenWidth(30));
...
final TextStyle titleBlack18 = TextStyle(
    fontWeight: FontWeight.w500, fontSize: getProportionateScreenWidth(15));
final TextStyle titleBlack20 = TextStyle(
    fontWeight: FontWeight.w500, fontSize: getProportionateScreenWidth(18));
