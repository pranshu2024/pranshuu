...
class Body extends StatefulWidget {
  const Body({super.key, required this.property, required this.unit});
                  ...
                  cells: [
                    ...
                    DataCell(Text(
                      monthFormat(
                        _today.add(
                          Duration(
                            days: widget.property.installment[index]
                                ['daysAfter'],
                          ),
                        ),
                      ),
                    ...
                    DataCell(Text(
                      (widget.property.installment[index]['percent'] /
                              100 *
                              widget.unit.price)
                          .round()
                          .toString(),
          ...
          DefaultButton(
            ...
            press: () async {
              ...
              final pdfFile = await PdfInvoice.generate(
                  properties: widget.property, units: widget.unit);
  ...
  Widget customTile(String text1, String text2) {
    return Container(
      ...
      decoration: const BoxDecoration(
          border: Border(top: BorderSide(color: fadeWhite, width: 0.3))),
      child: Row(
