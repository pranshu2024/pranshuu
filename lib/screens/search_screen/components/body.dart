...
class _BodyState extends State<Body> {
  ...
  RangeValues price = const RangeValues(0, 1000000);
  ...
  void statusChip(bool value, int index) {
    if (value) {
  ...
  void bedRoomChip(bool value, int index) {
    if (value) {
  ...
  void propertyTypeChip(bool value, int index) {
    if (value) {
  ...
  @override
  void initState() {
    BasicDataProvider basicProvider =
            ...
            child: Column(
              ...
              children: [
                ...
                DropDownBox(
                    ...
                    press: () {
                      bottomSheet(context, communityList, "Select Community",
                          bottomSheetCallback);
                    }),
                Wrap(
                  spacing: 10,
                ...
                DropDownBox(
                    ...
                    press: () {
                      bottomSheet(context, propertyList, "Select Property",
                          propertyBottomSheet);
                    }),
                Wrap(
                  spacing: 10,
        ...
        Positioned(
            ...
            child: Container(
                ...
                decoration: const BoxDecoration(
                    color: kFadeBlack,
                    border: Border(top: BorderSide(color: fadeWhite))),
                child: DefaultButton(
                    text: "Search",
                    press: () async {
                      ...
                      pushNewScreen(
                        // ignore: use_build_context_synchronously
                        context,
                        screen: PropertyList(unitList: units),
  ...
  void pushNewScreen(BuildContext context,
      {required PropertyList screen, required bool withNavBar}) {}
}
