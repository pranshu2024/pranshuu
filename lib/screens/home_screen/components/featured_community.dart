...
class FeaturedCommunityList extends StatelessWidget {
  const FeaturedCommunityList({super.key, required this.featuredCommunity});
        ...
        children: [
          ...
          Row(
            children: [
              Text(
                heading.toUpperCase(),
                style: titleWhite15.copyWith(
                    color: fadeWhite, fontWeight: FontWeight.bold),
              ),
              SizedBox(
      ...
      child: ListView.builder(
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: () async {
              List<Units> units = await CustomQuery().getUnitByCommunityId(
                  featuredCommunity[index].communityId, context);
