...
class SendData {
  ...
  Future getUser(context) async {
    ...
    userProvider.setUser(UserData(
        phoneNo: data['phoneNo'], name: data['name'], email: data['email']));
  }
  ...
  Future getTopPicks(context) async {
    ...
    var statusListMap = data;
    List<int> statusModelList =
        statusListMap['topPicksList'].map<int>((e) => e as int).toList();
  ...
  Future getFeaturedCommunity(context) async {
    ...
    List<FeaturedCommunity> featuredCommunityList =
        featureCommunityMap['featuredCommunityList']
            .map<FeaturedCommunity>((e) => FeaturedCommunity(
                image: e['image'],
                heading: e['heading'],
                amenities:
                    e['amenities'].map<String>((e) => e.toString()).toList(),
                communityId: e['communityId'],
                subheading: e['subheading']))
            .toList();
